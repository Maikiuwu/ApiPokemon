...
public class FavoriteController {
    ...
    public ResponseEntity<Favorite> guardarFavorito(@RequestBody Favorite favorite) {        
        Favorite newfavorite = favoriteService.addFavorite(favorite.getUserId(), favorite.getPokemonName(), favorite.getSpriteUrl());
    ...
    public ResponseEntity<String> eliminarFavorito(@RequestBody Favorite favorite) {
        try {
            favoriteService.removeFavorite(favorite.getUserId(), favorite.getPokemonName());
